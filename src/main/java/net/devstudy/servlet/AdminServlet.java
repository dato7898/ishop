...
@WebServlet(value = "/admin", initParams = {
	@WebInitParam(name = "ip", value = "192.168.0.103"),
	@WebInitParam(name = "accessKey", value = "admin"),
...
public class AdminServlet extends HttpServlet {
	...
	private void validate(String ip, String accessKey, String login, String password) throws IllegalStateException {
		...
		if (this.login.equals(login) && this.password.equals(password)) {
			System.out.println("Loggin via login and password: " + login + "/" + password);
			return;
		} else {
